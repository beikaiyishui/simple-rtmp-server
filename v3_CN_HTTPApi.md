...
* network: 这个配置了heartbeat使用的网卡ip，即SRS主动汇报的网卡信息。参考[Heartbeat](https://github.com/ossrs/srs/wiki/v1_CN_Heartbeat)
...
[raw-raw]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#raw
[raw-reload]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#reload
[raw-query]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#raw-query
[raw-update]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#raw-update
[raw-vhost]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#raw-vhost
[raw-dvr]: https://github.com/ossrs/srs/wiki/v3_CN_HTTPApi#raw-dvr
