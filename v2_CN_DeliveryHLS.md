...
部署分发HLS的实例，参考：[Usage: HLS](v2_CN_SampleHLS)
...
分发纯音频流不需要特殊配置，和HLS分发一样，参考：[Usage: HLS](v2_CN_SampleHLS)
...
SRS支持内存直接分发HLS，不写入磁盘。参考：[136](https://github.com/ossrs/srs/issues/136)
