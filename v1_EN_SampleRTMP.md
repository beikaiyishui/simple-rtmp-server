...
<strong>Step 3, config srs.</strong> For detail, read [RTMP](v1_EN_DeliveryRTMP)
...
<strong>Step 4, start srs.</strong> For detail, read [RTMP](v1_EN_DeliveryRTMP)

```bash
./objs/srs -c conf/rtmp.conf
```

<strong>Step 5, start encoder.</strong> For detail, read [RTMP](v1_EN_DeliveryRTMP)
...
<strong>Step 6, play RTMP.</strong> For detail, read [RTMP](v1_EN_DeliveryRTMP)
