...
关于SRS的QQ群和微信，参考：[https://github.com/ossrs/srs/wiki/v1_CN_Contact](v1_CN_Contact)
...
编译SRS的常见选项，SRS的功能，以及应用场景，编译和启动，DEMO的查看方法，如何Build SRS。链接：[编译SRS](v2_CN_Build)
...
## [SRS的架构](v2_CN_Architecture)

SRS开发者必看的基础wiki，SRS的基础架构。链接：[SRS的架构](v2_CN_Architecture)
...
## [FFMPEG直播流转码](v2_CN_FFMPEG)

如何使用SRS对直播流转码？如何只对视频或音频转码？如何配置台标？转码参数的意义和顺序？参考：[FFMPEG直播流转码](v2_CN_FFMPEG)
...
## [HTTP API管理接口](v2_CN_HTTPApi)

SRS是否提供HTTP API？如何管理服务器？页面js如何重启服务器，获取信息？php管理系统如何管理SRS服务器？参考：[HTTP管理接口](v2_CN_HTTPApi)
