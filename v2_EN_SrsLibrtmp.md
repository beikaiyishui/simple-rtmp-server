...
The example for bug [#212](https://github.com/ossrs/srs/issues/212#issuecomment-63648892) is srs_audio_raw_publish.c and srs_aac_raw_publish.c, read [examples](v2_EN_SrsLibrtmp#srs-librtmp-examples).
