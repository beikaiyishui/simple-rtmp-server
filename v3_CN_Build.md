...
更多使用方法，参考[Usage](https://github.com/ossrs/srs/tree/1.0release#usage)
...
* ./objs/lib/srs_librtmp.a SRS提供的客户端库，参考<a href="https://github.com/ossrs/srs/wiki/v2_CN_SrsLibrtmp">srs-librtmp</a>
...
* --with-http-callback 支持http回调接口，用于认证，统计，事件处理等。参考：[HTTP callback](v3_CN_HTTPCallback)
...
* --with-ffmpeg 编译转码/转封装/采集用的工具FFMPEG。参考：[FFMPEG](v3_CN_FFMPEG)
* --with-transcode 直播流转码功能。需要在配置中指定转码工具。参考：[FFMPEG](v3_CN_FFMPEG)
