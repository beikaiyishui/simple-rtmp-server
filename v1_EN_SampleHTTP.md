...
<strong>Step 3, config srs.</strong> For detail, read [HLS](v1_EN_DeliveryHLS)和[HTTP服务器](v1_EN_HTTPServer)
...
<strong>Step 4, start srs.</strong> For detail, read [HLS](v1_EN_DeliveryHLS)
